...
def text_processing(folder_path, test_size=0.2):
    folder_list = os.listdir(folder_path)  #['C000008', 'C000010', 'C000013', 'C000014', 'C000016', 'C000020', 'C000022', 'C000023', 'C000024']
    data_list = []
    class_list = []
    ...
    for folder in folder_list:
        ...
        files = os.listdir(new_folder_path)  #['10.txt', '11.txt', '12.txt', '13.txt', '14.txt', '15.txt', '16.txt', '17.txt', '18.txt', '19.txt']
        # 读取文件
        j = 1
        for file in files:
    ...
    #             all_words_dict[word] = 1
    word_list=[]
    for text_list in train_data_list:
