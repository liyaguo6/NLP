...
DB_DIRS = os.path.join(BASE_DIR,'database\SogouC\Sample')
STOPWORDS = os.path.join(BASE_DIR,'database\stop_words.pkl')
...
TEST_FILES =os.path.join(BASE_DIR,'database\\test.csv')